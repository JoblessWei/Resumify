// Every comment is meant to guide you (chatgpt) in finetuning the response for each generated property for every type being generated
// Types defined in typescript and it should be converted to json
type Profile = {
